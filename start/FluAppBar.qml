...
Rectangle{
    ...
    property string darkText : "Night mode"
    property string minimizeText : "minimize"
    property string restoreText : "Restore down"
    property string maximizeText : "maximize"
    property string closeText : "closure"
    property string stayTopText : "pin to top"
    property string stayTopCancelText : "Unpin"
    property color textColor: isDark ? "#FFFFFF" : "#000000"
    property color minimizeNormalColor: Qt.rgba(0,0,0,0)
    property color minimizeHoverColor: isDark ? Qt.rgba(1,1,1,0.03) : Qt.rgba(0,0,0,0.03)
    property color minimizePressColor: isDark ? Qt.rgba(1,1,1,0.06) : Qt.rgba(0,0,0,0.06)
    property color maximizeNormalColor: Qt.rgba(0,0,0,0)
    property color maximizeHoverColor: isDark ? Qt.rgba(1,1,1,0.03) : Qt.rgba(0,0,0,0.03)
    property color maximizePressColor: isDark ? Qt.rgba(1,1,1,0.06) : Qt.rgba(0,0,0,0.06)
    ...
    property color borerlessColor : isDark ? Qt.lighter("Blue") : Qt.darker("Blue")
    ...
    RowLayout{
        ...
        FluToggleSwitch{
            ...
            visible: showDark
            text:darkText
            isDark: control.isDark
            textColor:control.textColor
            checked: control.isDark
            textRight: false
        ...
        FluIconButton{
            ...
            radius: 0
            iconColor: d.stayTop ? (isDark ? Qt.lighter("Blue") : Qt.darker("Blue")) : control.textColor
